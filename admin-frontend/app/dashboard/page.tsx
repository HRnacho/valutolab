        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-5">
              ...
              <button onClick={() => () => { window.location.href = 'https://valutolab.com/dashboard' }} className="text-[13px] text-ink-500 hover:text-ink-900 transition-colors">Dashboard utente</button>
              <button onClick={async () => { await logout(); router.replace('/login') }} className="text-[13px] text-ink-500 hover:text-sienna-600 transition-colors">Esci</button>
            </div>
          </div>
        </div>
      </header>
